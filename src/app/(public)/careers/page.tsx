          ...
          {Array.from(new Set(jobs.map((j) => j.department))).map((dept) => (
            <span
              ...
              className={`px-4 py-1.5 rounded-full text-sm font-medium border ${
                departmentColors[dept] || "bg-surface-50 text-surface-600 border-surface-200"
              }`}
            >
            ...
            <div className="bg-white rounded-xl border border-surface-100 p-6 sm:p-8 shadow-sm">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-2">
                  <span className="inline-flex items-center gap-1 px-4 py-2 rounded-lg bg-primary-50 text-primary-700 font-medium text-sm group-hover:bg-primary-500 group-hover:text-white transition-all duration-300">
                    Apply Now
